...
toc:
  - name: Heat diffusion on Graphs
  - name: Sheaf theory fundamentals
...
## Questions
1. Do GNNs approximate the eigen vectors of graph laplacian?
2. What is the connection between message passing in GNNs and Diffusion?