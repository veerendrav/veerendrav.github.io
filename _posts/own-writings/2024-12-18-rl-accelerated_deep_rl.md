...
toc:
  - name: JAX Fundamentals(Numpy on steroids(GPUs))
  - name: Podracer architecture
  - name: Envpool
  - name: JAX for Deep Reinforcement Learning
    subsections:
      - name: PureJaxRL
      - name: Stoix
      - name: Rejax
      - name: 
  - name : JAX accelerated environments
    subsections:
      - name: gymnax
      - name: brax
      - name: navix
  ...
  - name: JAX accelerated algorithms
    subsections:
      - name: PQN  
  # - name: Equations
